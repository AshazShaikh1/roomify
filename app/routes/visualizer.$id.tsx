...
const VisualizerId = () => {
    ...
    const { initialImage, initialRender, name } = state;
    ...
    return (
        <div className='visualizer'>
            <nav className='topbar'>
                ...
                <Button variant='ghost' size='sm' onClick={handleBack} className='exit'><X className='icon' /> Exit Editor</Button>
            </nav>
            ...
            <section className='content'>
                <div className='panel'>
                    ...
                    <div className={`render-area ${isPorcessing
                        ? 'processing'
                        : ''
                        }`}>
                        {currentImage ? (
